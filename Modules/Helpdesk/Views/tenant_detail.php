    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('tenant/helpdesk') ?>" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <?php foreach ($replies as $reply): ?>
                                    ...
                                    // Jika internal, override dengan warna berbeda (tapi tenant tidak akan lihat internal)
                                    if ($isInternal) {
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form id="replyForm" method="post" action="<?= base_url('helpdesk/ticket/' . $ticket['id'] . '/reply') ?>">
                                <?= csrf_field() ?>
