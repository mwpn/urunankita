    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('tenant/content/pages/create') ?>" class="btn btn-sm btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="<?= base_url('tenant/content/pages/' . $page['id'] . '/edit') ?>" class="btn btn-sm btn-outline-secondary" title="Edit">
...
<script>
    function deletePage(id) {
        showConfirmation('Konfirmasi Hapus', 'Yakin ingin menghapus halaman ini?', function() {
            $.ajax({
                url: '<?= base_url('tenant/content/pages/delete/') ?>' + id,
                method: 'POST',
                data: {
