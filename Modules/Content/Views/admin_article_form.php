    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('admin/content/articles') ?>" class="btn btn-sm btn-outline-secondary mr-2">
            ...
            <!-- Form -->
            <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data" action="<?= $article ? base_url('admin/content/articles/update/' . $article['id']) : base_url('admin/content/articles/store') ?>" id="articleForm">
                <?= csrf_field() ?>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="d-flex justify-content-end">
                            <a href="<?= base_url('admin/content/articles') ?>" class="btn btn-outline-secondary mr-2">
