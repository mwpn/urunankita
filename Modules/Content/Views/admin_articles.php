    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('admin/content/articles/create') ?>" class="btn btn-sm btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?= base_url('article/' . $article['slug']) ?>" target="_blank" class="btn btn-sm btn-outline-primary" title="Lihat">
                                                    <span class="fe fe-eye fe-12"></span>
                                                </a>
                                                <a href="<?= base_url('admin/content/articles/' . $article['id'] . '/edit') ?>" class="btn btn-sm btn-outline-secondary" title="Edit">
...
<script>
    function deleteArticle(id) {
        showConfirmation('Konfirmasi Hapus', 'Yakin ingin menghapus artikel ini?', function() {
            $.ajax({
                url: '<?= base_url('admin/content/articles/delete/') ?>' + id,
                method: 'POST',
                data: {
