    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-3">
                <div class="col">
                    <h2 class="h5 page-title mb-0">Buat Laporan Transparansi</h2>
                    <small class="text-muted">Form untuk membuat laporan penggunaan dana baru</small>
                </div>
                <div class="col-auto">
                    <a href="<?= base_url('tenant/reports') ?>" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-header">
                            <strong class="card-title">Form Laporan Transparansi</strong>
                        </div>
                        <div class="card-body">
                            <form id="updateForm" class="needs-validation" novalidate method="POST" enctype="multipart/form-data" action="<?= base_url('campaign-update/create') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url('tenant/reports') ?>" class="btn btn-secondary">
                                        Batal
                                    </a>
                                </div>
                            </form>
