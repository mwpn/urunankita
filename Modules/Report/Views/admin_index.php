        ...
        <div class="col-12">
                ...
                <div class="col">
                    ...
                    <small class="text-muted">
                        <?php if (isset($tenants) && !empty($tenants)): ?>
                            Ringkasan laporan keuangan dari semua urunan
                        <?php else: ?>
                            Ringkasan laporan keuangan dari urunan milik admin
                        <?php endif; ?>
                    </small>
                </div>
                <div class="col-auto">
                    <div class="btn-group">
                        <a href="<?= base_url('admin/reports/create') ?>" class="btn btn-sm btn-primary">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        ...
                                        <select id="tenant-filter" class="form-control form-control-sm" onchange="filterByTenant(this.value)">
                                            <?php 
                                            $isAllPage = strpos(uri_string(), 'admin/all/reports') !== false;
                                            $baseUrl = $isAllPage ? base_url('admin/all/reports') : base_url('admin/reports');
                                            ?>
                                            <option value="<?= $baseUrl ?>" <?= !isset($selectedTenantId) || $selectedTenantId === '' ? 'selected' : '' ?>>Semua Tenant</option>
                                            <?php foreach ($tenants as $tenant): ?>
                                                <option value="<?= $baseUrl . '?tenant_id=' . $tenant['id'] ?>" <?= isset($selectedTenantId) && $selectedTenantId == $tenant['id'] ? 'selected' : '' ?>>
                                                    <?= esc($tenant['name']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
            ...
            foreach ($campaigns as $campaign) {
                ...
                $campaignStats[] = [
                    ...
                    'tenant_name' => $campaign['tenant_name'] ?? null,
                        ...
                        <div class="card-body">
                            <?php if (empty($campaignStats)): ?>
                                <div class="text-center py-5">
                                    <p class="text-muted mb-4">Belum ada urunan. <a href="<?= base_url('admin/campaigns/create') ?>" class="text-primary">Buat urunan baru</a> terlebih dahulu.</p>
                                </div>
                            <?php else: ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($campaignStats as $stat): ?>
                                                <tr>
                                                    ...
                                                    <?php if (isset($tenants) && !empty($tenants)): ?>
                                                        <td>
                                                            <?php if (!empty($stat['tenant_name'])): ?>
                                                                <span class="badge badge-secondary"><?= esc($stat['tenant_name']) ?></span>
                                                            <?php else: ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <a href="<?= base_url('admin/campaigns/' . $stat['id']) ?>" class="btn btn-sm btn-outline-primary">
        ...
        function initDataTable() {
            if (typeof $.fn.DataTable !== 'undefined' && $('#dataTable-laporan-semua').length) {
                ...
                $('#dataTable-laporan-semua').DataTable({
                    ...
                    "order": [[<?= isset($tenants) && !empty($tenants) ? '3' : '2' ?>, "desc"]], // Sort by total donasi descending
                    "language": {
                        "search": "Cari:",
