                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow">
                        <div class="card-body text-center">
                            ...
                            <h5 class="mb-1"><?= esc($user['name'] ?? 'User') ?></h5>
                            <p class="text-muted small mb-3"><?= esc($user['email'] ?? '') ?></p>
                            <div class="mb-3">
                                <span class="badge badge-<?= ($user['role'] ?? '') === 'superadmin' || ($user['role'] ?? '') === 'super_admin' ? 'success' : 'info' ?>">
                                    <?= ($user['role'] ?? '') === 'superadmin' || ($user['role'] ?? '') === 'super_admin' ? 'Admin' : 'Penggalang Dana' ?>
                                </span>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $stats['total_campaigns'] > 0 ? 100 : 0 ?>%"></div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between mb-1">
                                ...
                                <div>
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <strong><?= number_format($stats['active_campaigns']) ?></strong>
                                    </div>
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: <?= $stats['total_campaigns'] > 0 ? ($stats['active_campaigns'] / $stats['total_campaigns']) * 100 : 0 ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0"><strong><?= esc($tenant['name'] ?? '-') ?></strong></p>
                                    </div>
                                    <div class="col-md-6">
                                        <small class="text-muted d-block mb-1">Slug</small>
                                        <p class="mb-0"><strong><?= esc($tenant['slug'] ?? '-') ?></strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0">
                                                <strong>
                                                    <a href="<?= base_url('tenant/dashboard') ?>" target="_blank" class="text-primary">
                ...
                <form id="formEditProfil">
                    ...
                    <?php if ($tenant): ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tenant_name" value="<?= esc($tenant['name'] ?? '') ?>" readonly>
                        </div>
                    <?php endif; ?>
                </form>
            </div>
...
<script>
    ...
    function submitEditProfile() {
        ...
        fetch('<?= base_url('tenant/profile/update') ?>', {
            method: 'POST',
            headers: {
    ...
    function submitAvatar() {
        ...
        fetch('<?= base_url('tenant/profile/avatar') ?>', {
            method: 'POST',
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            },
