            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-auto">
                    <div class="btn-group">
                        ...
                        <a href="<?= base_url('admin/campaigns/' . $campaign['id'] . '/edit') ?>" class="btn btn-sm btn-outline-primary">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <?php if (!empty($donations)): ?>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?= base_url('admin/donations?campaign_id=' . $campaign['id']) ?>" class="btn btn-sm btn-outline-primary btn-block mt-3">
                                    Lihat Semua Donasi
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <a href="<?= base_url('admin/reports/create?campaign_id=' . $campaign['id']) ?>" class="btn btn-sm btn-outline-primary btn-block mb-2">
...
<script>
    ...
    document.getElementById('dc-submit').addEventListener('click', async function() {
        ...
        try {
            const response = await fetch('<?= base_url('admin/campaigns') ?>/' + campaignId + '/delete', {
                method: 'POST',
                headers: {
