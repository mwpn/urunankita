    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('admin/campaigns') ?>" class="btn btn-sm btn-outline-secondary mr-2">
            ...
            <!-- Form -->
            <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data" action="<?= $campaign ? base_url("admin/campaigns/{$campaign['id']}/update") : base_url('admin/campaigns/store') ?>" id="campaignForm">
                <?= csrf_field() ?>
                
                <!-- Hidden tenant_id for platform -->
                <input type="hidden" name="tenant_id" value="<?= $platform_tenant_id ?? 1 ?>">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="custom-control custom-switch mb-2">
                                            <input type="checkbox" class="custom-control-input" id="customDraft" name="status" value="draft" onchange="toggleDraftStatus()">
                                    ...
                                    <div>
                                        <a href="<?= base_url('admin/campaigns') ?>" class="btn btn-outline-secondary mr-2">Batal</a>
...
<script>
    (function() {
        ...
        // Toggle draft status - same as tenant form
        function toggleDraftStatus() {
            // Form will submit status=draft if checked, or no status field if unchecked (defaults to active in controller)
        }
