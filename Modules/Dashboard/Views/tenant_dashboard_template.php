        ...
        <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <h3 class="mb-0">Rp <?= number_format($stats['total_donations'] ?? 0, 0, ',', '.') ?></h3>
                                    <span class="small text-success"><span class="fe fe-arrow-up fe-12"></span> Aktif</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-12 col-lg-3 col-md-6 mb-4 mb-lg-0">
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <small class="text-muted mb-1">Urunan Aktif</small>
                                    <h3 class="mb-0"><?= number_format($stats['active_campaigns'] ?? 0) ?></h3>
                                    <span class="small text-info"><span class="fe fe-arrow-up fe-12"></span> <?= number_format($stats['active_campaigns'] ?? 0) ?> aktif</span>
                                </div>
                                <div class="col-auto">
                                    <div class="card-icon bg-info bg-opacity-25 text-info">
                                        <span class="fe fe-play-circle fe-24"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-3 col-md-6">
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <small class="text-muted mb-1">Total Donatur</small>
                                    <h3 class="mb-0"><?= number_format($stats['total_donors'] ?? 0) ?></h3>
                                    <span class="small text-muted">Total donatur</span>
                                </div>
                                <div class="col-auto">
            ...
            <div class="row mb-4">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card shadow">
                        <div class="card-header">
                            <strong class="card-title">Urunan Terbaru</strong>
                            <a class="float-right small text-muted" href="/tenant/campaigns">Lihat semua</a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="list-group list-group-flush my-n3">
                                    <?php foreach (array_slice($recent_campaigns, 0, 5) as $campaign): ?>
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span class="fe fe-heart text-danger fe-16"></span>
                                                </div>
                                                <div class="col">
                                                    <small><strong><?= esc($campaign['title']) ?></strong></small>
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    $badgeClass = $status === 'active' ? 'badge-light' : ($status === 'completed' ? 'badge-success' : 'badge-secondary');
                            ...
                            <?php else: ?>
                                <p class="text-muted mb-0">Belum ada urunan</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-header">
                            ...
                            <a class="float-right small text-muted" href="/tenant/donations">Lihat semua</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php foreach (array_slice($recent_donations, 0, 10) as $donation): ?>
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ml-n2">
                                                    <small><strong><?= esc($donation['donor_name'] ?? 'Anonim') ?></strong></small>
                                                    <div class="my-0 small text-muted"><?= esc($donation['campaign_title'] ?? '-') ?></div>
                                                </div>
                                                <div class="col-auto">
                                                    <small class="text-success"><strong>Rp <?= number_format($donation['amount'] ?? 0, 0, ',', '.') ?></strong></small>
                                                    <div class="small text-muted"><?= date('d M Y', strtotime($donation['created_at'] ?? 'now')) ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
