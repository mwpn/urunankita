...
class TenantController extends BaseController
{
    ...
    public function createStaff(int $id)
    {
        ...
        try {
            ...
            // This ensures staff can login even if not assigned to specific campaigns yet
            if (!$hasTenantId && $insertedUserId) {
                // Get first campaign from this tenant as marker
                ...
                if ($firstCampaign) {
                    ...
                    // This entry will be used to resolve tenant_id during login
                    // Check if entry already exists to avoid duplicate
                ...
                // Note: If tenant has no campaigns yet, staff won't be able to login until:
                // 1. At least one campaign is created, OR
                // 2. Staff is manually assigned to a campaign via UI
            }
